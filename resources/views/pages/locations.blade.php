...
@section('content')
<x-hero title="Active Service Locations" eyebrow="Locations" :image="$images['road']">City pages are active only where service coverage is confirmed. Future cities can be published when operations are ready.</x-hero>
